//Převod zeměpisných souřadnic ze systému WGS-84 na S-JTSK
//Ukradeno z: https://www.pecina.cz/krovak.html
...
function ci(x) {
  var c = Number( x.replace(',','.') );
  return ( isNaN(c) ? 0 : c );
}

function convert(lat, lon, alt) { //alt (the altitude) is optional: 200 meters is the default
  var d2r = Math.PI/180;
  var a = 6378137.0;
  ...
  //console.log('Výsledek: CX='+CX.toFixed(1)+' CY='+CY.toFixed(1));
  return [CX, CY]
}

// example:
// console.log(
//   convert(49.1891646951735, 16.613473892211918)
// );
